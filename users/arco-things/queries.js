...
let getThings = (index) => {
    ...
    WHERE {
        GRAPH <https://w3id.org/arco/data> {
            {
            ?thing a <https://w3id.org/arco/ontology/arco/ImmovableCulturalProperty>
            } UNION {
            ?subclass a <https://w3id.org/arco/ontology/catalogue/CatalogueRecordOA> .
            ?subclass <https://w3id.org/arco/ontology/catalogue/describesCulturalProperty> ?thing .
            }
        }
        MINUS  {
        ...
        OPTIONAL {
          ...
          ?type <https://w3id.org/arco/ontology/denotative-description/hasCulturalPropertyDefinition> ?def .
          ?def rdfs:label ?label .
          BIND(LCASE(?label) as ?class)
        }
    } GROUP BY ?thing
      LIMIT 10000
      OFFSET ${index*10000}
